...
### المصادر
  ...
  1. [مصحف عماد](../../content/technologies/ar/MushafImad.md): هي حزمة برمجية بلغة (Swift) تمدّ تطبيقات نظام (iOS) بمحرّك لعرض المصحف، ومشغل صوتي، بالإضافة إلى كافة المزايا الأساسية التي يجب أن يتضمنها أي تطبيق قرآني.

  2. [مصحف عماد أندرويد](../../content/technologies/ar/MushafImad.md): هي نسخة MushafImad ولكن بلغة (Kotlin) والتي توفر نفس المزايا ولكن لنظام اندرويد.
