...
1. Hafs (حفص):
    ...
    a. Medina Transcript: King Fahd Quran Complex, Multiple Formats  [https://qurancomplex.gov.sa/quran-dev/](https://qurancomplex.gov.sa/quran-dev/)

    b. Shamarly: PNG image per Page <https://github.com/Mr-DDDAlKilanny/shamraly-images>

    c. Medina Transcript: <https://quraankarem.wordpress.com/qurancomplex/>

    d. Shamarly Transcript: <https://quraankarem.wordpress.com/shamarly/>

    e. Medina: EveryAyah.com, PNG image per Ayah <https://everyayah.com/data/quranpngs/>  

    f. Medina: EveryAyah.com, JPG image per Ayah <https://everyayah.com/data/QuranText_jpg/>

    g. Multiple: <https://qul.tarteel.ai/resources/mushaf-layout>
        1. Script to Download Mushaf pages from QUL <https://github.com/blueheron786/get-quran-mushaf-images>

2. Warsh (ورش)

    Medina Transcript: King Fahd Quran Complex  [https://qurancomplex.gov.sa/quran-dev/](https://qurancomplex.gov.sa/quran-dev/)
...
1. Hafs (حفص):
    ...
    a. Quran Foundation, <https://api-docs.quran.foundation/docs/content_apis_versioned/quran-verses-indopak> [API]

    b. King Fahd Quran Complex, [csv, html, json, sql, txt, xlsx, xml]  [https://qurancomplex.gov.sa/quran-dev/](https://qurancomplex.gov.sa/quran-dev/) [Downloadable]

    c. Every Ayah [XML] <https://everyayah.com/data/XML/Arabic/>

    d. Tanzil[Bar Seperated Values, XML, SQL (MySql dump)] <https://tanzil.net/download/>

    e. Mushaf Mauri: <https://github.com/Zizwar/mushaf-mauri/tree/main/assets/pages/hafsTajweed>

2. Warsh (ورش)

    a. Medina Transcript: King Fahd Quran Complex, [csv, html, json, sql, txt, xlsx, xml]  [https://qurancomplex.gov.sa/quran-dev/](https://qurancomplex.gov.sa/quran-dev/) [Downloadable]

    b. Mushaf Mauri: <https://github.com/Zizwar/mushaf-mauri/tree/main/assets/pages/muhammadi> -- TODO: Hassaan: needs verification if this is warsh
...
1. Arabic:
    ...
    a. Kalimat.dev <https://www.kalimat.dev/> :

    sometimes is not accurate for instance searching for "عرب" returns results that are not related to search

    b. Quran Foundation: <https://api-docs.quran.foundation/docs/content_apis_versioned/search>

2. English:

    a. <https://www.kalimat.dev/>
