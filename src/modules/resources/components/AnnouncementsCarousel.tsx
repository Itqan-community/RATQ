...
function resolveMessage(messages: ReturnType<typeof import('@/shared/ui/i18n').useTranslations>, key: string): string {
...
function formatRelativeTime(dateStr: string, t: ReturnType<typeof import('@/shared/ui/i18n').useTranslations>): string {
  const now = new Date();
