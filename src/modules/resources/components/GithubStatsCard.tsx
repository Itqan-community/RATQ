...
interface GithubStatsCardProps {
  // Real GitHub repo URL - the parent only renders this card for resources
  // with a parseable GitHub URL (see ResourceDetailClient), so there is no
  // "#"/fallback contract here anymore (issue #299).
  githubUrl: string;
