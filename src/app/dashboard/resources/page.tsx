...
export default function DashboardResourcesPage() {
  ...
  const handleEdit = async (data: { name: string; type: ResourceType; short_description: string; description: string; license: string; github_url: string; documentation_url: string; }) => {
